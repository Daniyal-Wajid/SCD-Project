  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        Welcome to <span className="font-semibold text-secondary">EventEase</span>, your trusted partner for seamless event management.
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        ...
        Whether you’re a business owner offering halls, catering, or decor, or a user looking to plan your dream event, <span className="font-semibold text-secondary">EventEase</span> is here to simplify the process.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
